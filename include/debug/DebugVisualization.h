...
public:
    ...
    void drawRay(const Math::Vector2D& origin, const Math::Vector2D& direction,
                float length, const Graphics::Color& color = Graphics::Color(255, 0, 0));
...
public:
    ...
    void addTextFormat(const Math::Vector2D& position,
...
public:
    ...
    void visualizeEntityBounds(uint32_t entityId,
...
public:
    static void drawPoint(const Math::Vector2D& point,
                         float size = 5.0f,
                         const Graphics::Color& color = Graphics::Color(255, 255, 255));
    ...
    static void drawBezierCurve(const Math::Vector2D& p0,
