...
class ResourceManager {
   ...
   public:
    ...
    // Texture management
    std::shared_ptr<Graphics::Texture> loadTexture(const std::string& id,
    ...
    void loadTextureWithCallback(const std::string& id, const std::string& filePath,
...
class BundleBuilder {
   public:
    ...
    void addAsset(const std::string& assetId, const std::vector<uint8_t>& data,
...
class BundlePatcher {
   public:
    ...
    // Create patch
    bool createPatch(const std::string& oldBundlePath, const std::string& newBundlePath,
                     const std::string& patchOutputPath);

    // Apply patch
    bool applyPatch(const std::string& bundlePath, const std::string& patchPath,
